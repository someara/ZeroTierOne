/// Minimal ZeroTea Service — Just demonstrates working integration
///
/// This shows:
...
pub fn main() !void {
    ...
    std.debug.print("Phase 1: Initializing ZeroTea Node\n", .{});
    std.debug.print("──────────────────────────────────────────────────────\n", .{});
    ...
    const node = try Node.init(allocator, null, null, &config, node_callbacks, start_time);
    defer node.deinit();
    ...
    std.debug.print("\n", .{});
    std.debug.print("✓ ZeroTea core is functional!\n", .{});
...
fn printBanner() void {
    ...
    std.debug.print("╔═══════════════════════════════════════════════════════╗\n", .{});
    std.debug.print("║                                                       ║\n", .{});
    std.debug.print("║            ZeroTea Minimal Service Demo              ║\n", .{});
    std.debug.print("║                                                       ║\n", .{});
