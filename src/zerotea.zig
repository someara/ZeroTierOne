...
/// Run:   sudo ./zig-out/bin/zerotea
const std = @import("std");
const Service = @import("zerotea_service.zig").Service;
...
fn printBanner() void {
    ...
    std.debug.print("╔═══════════════════════════════════════════════════════╗\n", .{});
    std.debug.print("║                                                       ║\n", .{});
    std.debug.print("║                ZeroTea — Zig Port                    ║\n", .{});
    std.debug.print("║                                                       ║\n", .{});
...
fn printHelp() void {
    std.debug.print("Usage: zerotea [OPTIONS]\n\n", .{});
    ...
    std.debug.print("  sudo ./zerotea                   # Run on port 9993\n", .{});
    std.debug.print("  ./zerotea -p 9994                # Run on alternate port\n", .{});
    std.debug.print("  sudo ./zerotea --tun             # With TUN device (requires root)\n", .{});
    std.debug.print("  ./zerotea -d /tmp/zt             # Use specific directory\n", .{});
    std.debug.print("\n", .{});
}
