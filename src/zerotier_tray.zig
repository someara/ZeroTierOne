/// ZeroTier macOS Tray Application
///
/// Native macOS menu bar app that communicates with zerotier-one via its
/// HTTP API at localhost:9993. Shows joined networks, allows joining/leaving,
/// and displays service status.
///
/// Build: zig build tray
/// Run:   ./zig-out/bin/ZeroTierTray
...
/// Read auth token from standard ZeroTier paths
